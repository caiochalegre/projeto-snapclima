...
const api_key = "f9357026e752c1cbc86506156a995aba";

//Reconhecer quando o usuário clicar no botão
citySearchButton.addEventListener("click", () => {
    let cityName = citySearchInput.value
    getCityWeather(cityName)
})

//Encarregar que o navegador busque a localização atual do usuário no momento em que a aplicação iniciar
...
//Reconhecer o que o usuário digitou e converter os dados da API
...
//Filtrar e mostrar os dados da API
